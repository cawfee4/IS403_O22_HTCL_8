...
\begin{itemize}
    \item For CMG:
    \begin{itemize}
        \item For 70:30, the best model is DLinear with the lowest RMSE, MAE, and MAPE.
        \item For 80:20, the best model is DLinear with the lowest RMSE, MAE, and MAPE.
        \item For 90:10, the best model is DLinear with the lowest RMSE, MAE, and MAPE.
    \end{itemize}
    \item For FPT:
    \begin{itemize}
        \item For 70:30, the best model is DLinear with the lowest RMSE, MAE, and MAPE.
    ...
    \item For ITD:
    \begin{itemize}
        \item For 70:30, the best model is SARIMAX with the lowest RMSE, MAE, and MAPE.
        \item For 80:20, the best model is SARIMAX with the lowest RMSE, MAE, and MAPE.
        \item For 90:10, the best model is SARIMAX with the lowest RMSE, MAE, and MAPE.
    \end{itemize}
\end{itemize}
