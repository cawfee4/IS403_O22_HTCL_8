...
\begin{document}
\title{Using statistical models Machine Learning to predict stock prices of Vietnamese tech companies}
...
\begin{keywords}
    predict stock price, linear regression, GRU, LSTM, RNN, ARIMA, SARIMAX,
\end{keywords}
